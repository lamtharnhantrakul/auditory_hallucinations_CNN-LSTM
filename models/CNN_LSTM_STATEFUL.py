...
def createModel(image_dim=(224,224,3), audio_vector_dim=16, learning_rate=0.4e-6, weight_init=0.01):
...
# Put these in a callback list, Model saving now occurs in the callback on epoch end
...
# Setup training for Stateful LSTM mode. Must define for loops and model.reset() manually.
num_epochs = 15
seq_length = 20
batch_size = 256
